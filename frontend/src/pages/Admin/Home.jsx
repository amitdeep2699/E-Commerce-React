        ...
        <div className="row justify-content-center align-items-center" style={{height:"90vh"}}>
            <div className="col-6 " style={{backgroundColor: "aqua"}}>
                    <form action="" encType="multipart/form-data" onSubmit={submitProduct}>
                            ...
                            <label htmlFor="seller" style={{fontSize: "large"}}>Seller Name:</label><input className="mx-4 mb-2"
                                type="text" name="seller" id="seller" placeholder="seller Name"
                                style={{width: "40%"}} value={productData.seller} onChange={handler} required /><br/>
