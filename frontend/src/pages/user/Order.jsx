...
const Order=()=>{
    ...
    useEffect(()=>{
        ...
        fetch("http://localhost:3000/getAllUserOrderData",{
        method: "POST",
                                    ...
                                    <div className="card shadow-0 border ml-1 mr-1 mb-4">
                                        <div className="card-body">
                                            <div className="row">
                                                ...
                                                <div className="col-md-2 text-center text-muted d-flex justify-content-center align-items-center">
                                                <span style={{fontWeight:'bold'}}>Product Name: </span> <p className="text-muted mb-0 P_name">{item.name}</p>
                                                </div>
                                                <div className="col-md-4 text-center text-muted d-flex justify-content-center align-items-center">
                                                <span style={{fontWeight:'bold'}}>Payment id: </span> <p className="text-muted mb-0 small P_pay_id">{item.payment_id}</p>
                                                </div>
                                                <div className="col-md-2 text-center text-muted d-flex justify-content-center align-items-center">
                                                <span style={{fontWeight:'bold'}}>Qty: </span>    <p className="text-muted mb-0 small P_quant"> {item.order_qunatity}</p>
                                                </div>
                                                <div className="col-md-2 text-center text-muted d-flex justify-content-center align-items-center">
                                                <span style={{fontWeight:'bold'}}>Total Prices: </span>    <p className="text-muted mb-0 small P_totalPrices">₹ {item.total_price}</p>
                                                </div>
                                            </div>
